...
var HelloWorld = function () {
    var _classDecorators = [(0, decorators_js_1.customElement)("hello-world")];
    ...
    var HelloWorld = _classThis = /** @class */ (function (_super) {
        ...
        HelloWorld_1.prototype.render = function () {
            //return render(html`
    ...
    (function () {
        ...
        _name_decorators = [(0, decorators_js_1.property)({ type: String, reflect: true })];
